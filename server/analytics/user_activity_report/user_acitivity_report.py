...
class UserActivityReportResource(Resource):
    ...
    schema = {
        ...
        "min": {"type": "datetime", "required": False},
        "max": {"type": "datetime", "required": False},
        "highcharts": {
            "type": "list",
            "required": False,
            "schema": {"type": "dict", "schema": {}, "allow_unknown": True},
...
class UserActivityReportService(StatsReportService):
    ...
    defaultConfig = {
        ...
        REPORT_CONFIG.DEFAULT_PARAMS: {"chart": {"type": CHART_TYPES.TABLE}},
    }
    ...
    def generate_report(self, docs, args):
        ...
        for doc in docs:
            ...
            timeline = [calc_timestamp(entry) for entry in stats.get("timeline") or []]
