...
class DeskActivityReportResource(Resource):
    ...
    schema = {
        ...
        "incoming": {"type": "list", "schema": {"type": "number"}},
        "outgoing": {"type": "list", "schema": {"type": "number"}},
        "histogram": {"type": "list", "schema": {"type": "number"}},
        "highcharts": {
            "type": "dict",
            "required": False,
            "schema": {},
...
class DeskActivityReportService(BaseReportService):
    ...
    def generate_report(self, docs, args):
        ...
        for bucket in date_buckets:
            ...
            histogram = {
                ...
                "incoming": {key: 0 for key in ENTER_DESK_OPERATIONS},
                "outgoing": {key: 0 for key in EXIT_DESK_OPERATIONS},
                "other": {},
            }
    ...
    def generate_highcharts_config(self, docs, args):
        ...
        report["highcharts"] = [gen_chart_config(), gen_table_config()]
