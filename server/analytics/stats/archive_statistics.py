...
class ArchiveStatisticsResource(Resource):
    ...
    schema = {
            ...
            "schema": {
                STAT_TYPE.TIMELINE: {
                    ...
                    "schema": {
                        "type": "dict",
                        "schema": {
                            "history_id": {"type": "string", "mapping": not_indexed},
                            "related_history_id": {
                                "type": "string",
                                "mapping": not_indexed,
                            },
                            ...
                            "update": {"type": "dict", "mapping": not_enabled},
                        },
                    },
                    "mapping": {
                        "type": "nested",
                ...
                STAT_TYPE.FEATUREMEDIA_UPDATES: {
                    ...
                    "schema": {
                        ...
                        "schema": {
                            ...
                            "renditions": {"type": "dict", "mapping": not_indexed},
                            "poi": {"type": "dict", "mapping": not_enabled},
                        },
                    },
                    "mapping": {
                        "type": "nested",
        ...
        "time_to_next_update_publish": {"type": "integer", "default": 0},
        "num_desk_transitions": {"type": "integer", "default": 0},
        "num_featuremedia_updates": {"type": "integer", "default": 0},
        # Dictionary for statistics generated via plugins (i.e. from gen_stats_signals)
        "extra": {"type": "dict", "mapping": not_enabled},
    }
