...
base_config = {
    ...
    REPORT_CONFIG.DATE_FILTERS: {
        ...
        # HOURS
        DATE_FILTERS.RELATIVE_HOURS: {"enabled": True, "max": 72},
        # DAYS
        DATE_FILTERS.RELATIVE_DAYS: {"enabled": True, "max": 31},
        DATE_FILTERS.YESTERDAY: {"enabled": True},
        DATE_FILTERS.TODAY: {"enabled": True},
        # WEEKS
        DATE_FILTERS.RELATIVE_WEEKS: {"enabled": True, "max": 52},
        DATE_FILTERS.LAST_WEEK: {"enabled": True},
        DATE_FILTERS.THIS_WEEK: {"enabled": True},
        # MONTHS
        DATE_FILTERS.RELATIVE_MONTHS: {"enabled": True, "max": 12},
