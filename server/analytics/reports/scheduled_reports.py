...
class ScheduledReportsResource(Resource):
    ...
    schema = {
        ...
        "transmitter": {"type": "string", "required": True, "allowed": ["email"]},
        "recipients": {"type": "list", "required": True, "schema": {"type": "string"}},
        "name": {"type": "string", "required": True},  # used to construct email subject
        "description": {"type": "string"},
        "active": {"type": "boolean", "default": False},
        "extra": {"type": "dict"},  # i.e. email body
        "_last_sent": {"type": "datetime"},
    }
