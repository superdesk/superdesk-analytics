...
export function AnalyticsSettings(desks, workspaces, session, preferencesService, WizardHandler, $filter) {
    return {
        templateUrl: 'analytics-widget/views/analytics-settings-configuration.html',
        scope: {
            modalActive: '=',
            desks: '=',
            deskStages: '=',
        ...
        link: function(scope, elem) {
            window.console.log('sss', scope);
            var PREFERENCES_KEY = 'acc:view';
            ...
            scope.previous = function() {
                WizardHandler.wizard('analyticssettings').previous();
            };

            scope.next = function() {
                WizardHandler.wizard('analyticssettings').next();
            };
            ...
            scope.getValues = function() {
                window.console.log('eee', scope.editGroups);
                ...
                window.console.log('vvvv', values);
                return values;
            };

            scope.getOperationType = function() {
                window.console.log('ccccc');
                // var values = Object.keys(scope.)
            };
